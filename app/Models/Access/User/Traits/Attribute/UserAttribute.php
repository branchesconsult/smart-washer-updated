...
trait UserAttribute
{
    ...
    public function getShowButtonAttribute($class)
    {
        ...
        if (request()->has('laundry_id')) {
            $laundryId = '?laundry_id=' . request()->get('laundry_id');
        }
        if (access()->allow('show-user')) {
            return '<a class="' . $class . '" href="' . route('admin.access.user.show', $this) . $laundryId . '">
    ...
    public function getDeleteButtonAttribute($class)
    {
        if ($this->id != access()->id() && access()->allow('delete-user')) {
            ...
            return '<a class="' . $class . '" href="' . route('admin.access.user.destroy', $this) . '"
                 ...
                 <i class="fa fa-trash" data-toggle="tooltip" data-placement="top" title="' . trans('buttons.general.crud.delete') . '">
