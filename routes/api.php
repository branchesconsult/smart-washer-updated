...
Route::group(['namespace' => 'Api\V1', 'prefix' => 'v1', 'as' => 'v1.', 'middleware' => ['sessions']], function () {
    ...
    Route::group(['namespace' => 'Driver', 'prefix' => 'driver-app'], function () {
        Route::get('ordersTest', 'DriverOrderController@getDriverOrders');
    });
    /**
     * Site settings
     */
