...
<head>
    ...
    <style type="text/css">
        ...
        @tab Mobile Styles
        333333333333333333 Preheader Visibility
        ...
        @tab Mobile Styles
        333333333333333333 Preheader Text
        ...
        @tab Mobile Styles
        333333333333333333 Header Text
        ...
        @tab Mobile Styles
        333333333333333333 Footer Text
                                                                                                    ...
                                                                                                    <table align="left"
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td align="center"
                                                                                                                ...
                                                                                                                <a href="http://www.twitter.com/smartwashr"
                                                                                                                   target="_blank"><img
                                                                                                                            src="{!! asset('img/color-twitter-48.png') !!}"
                                                                                                                            style="display:block;"
                                                                                                                            height="24"
                                                                                                                            width="24"
                                                                                                                            class=""></a>
                                                                                                    ...
                                                                                                    <table align="left"
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td align="center"
                                                                                                                ...
                                                                                                                width="24"
                                                                                                                class="mcnFollowIconContent">
                                                                                                                <a href="http://www.facebook.com/smartwashr"
                                                                                                                   target="_blank"><img
                                                                                                                            src="{!! asset('img/color-facebook-48.png') !!}"
                                                                                                                            style="display:block;"
                                                                                                                            height="24"
                                                                                                                            width="24"
                                                                                                                            class=""></a>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td align="center"
                                                                                                                ...
                                                                                                                <a href="http://mailchimp.com"
                                                                                                                   target="_blank"><img
                                                                                                                            src="{!! asset('img/color-link-48.png') !!}"
                                                                                                                            style="display:block;"
                                                                                                                            height="24"
                                                                                                                            width="24"
                                                                                                                            class=""></a>
                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td valign="top" class="mcnTextContent"
                                                    ...
                                                    <em>Copyright &copy; {!! date('Y') !!} Smart Washr, All rights
                                                        reserved.</em><br>
                                                    <br>
                                                    <br>
                                                    ...
                                                    <br>
                                                    3333 Arafat St.<br/>
                                                    AlAndalus District, Kingdom of Saudi Arabia<br/>
