<!--Action Button-->
@if( Active::checkUriPattern( 'admin/userdevices' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.userdevices.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.userdevices.all' ) }}
            </a>
        </li>
        @permission( 'create-userdevice' )
            <li>
                <a href="{{ route( 'admin.userdevices.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.userdevices.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
