<!--Action Button-->
@if( Active::checkUriPattern( 'admin/laundries' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.laundries.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.laundries.all' ) }}
            </a>
        </li>
        @permission( 'create-laundry' )
        @if( !Active::checkUriPattern( 'admin/laundries' ) && !Active::checkUriPattern( 'admin/laundries/create' ) )
            <li>
        ...
        <li>
            <a href="{{ route( 'admin.laundries.create' ) }}">
                <i class="fa fa-plus"></i> {{ trans( 'menus.backend.laundries.create' ) }}
            </a>
        </li>
        @endauth
    </ul>
