<!--Action Button-->
@if( Active::checkUriPattern( 'admin/pushnotifications' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.pushnotifications.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.pushnotifications.all' ) }}
            </a>
        </li>
        @permission( 'create-pushnotification' )
            <li>
                <a href="{{ route( 'admin.pushnotifications.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.pushnotifications.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
