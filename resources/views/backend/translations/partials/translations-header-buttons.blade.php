<!--Action Button-->
@if( Active::checkUriPattern( 'admin/translations' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.translations.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.translations.all' ) }}
            </a>
        </li>
        @permission( 'create-translation' )
            <li>
                <a href="{{ route( 'admin.translations.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.translations.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
