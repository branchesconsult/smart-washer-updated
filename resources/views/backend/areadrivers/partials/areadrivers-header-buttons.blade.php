<!--Action Button-->
@if( Active::checkUriPattern( 'admin/areadrivers' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.areadrivers.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.areadrivers.all' ) }}
            </a>
        </li>
        @permission( 'create-areadriver' )
            <li>
                <a href="{{ route( 'admin.areadrivers.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.areadrivers.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
