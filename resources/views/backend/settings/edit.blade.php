        ...
        <div class="box-body setting-block">
            ...
            <ul id="myTab" class="nav nav-tabs setting-tab-list" role="tablist">
                ...
                <li role="presentation">
                    <a href="#tab2" aria-controls="1" role="tab"
                       data-toggle="tab">Shop settings</a>
                </li>
                <li role="presentation">
                ...
                <li role="presentation">
                    <a href="#tab7" aria-controls="5" role="tab"
                       data-toggle="tab">Delivery Fees</a>
                </li>
                <li role="presentation">
                    <a href="#tab8" aria-controls="5" role="tab"
                       data-toggle="tab">Sorting Fees</a>
                </li>
            </ul>
            ...
            <div id="myTabContent" class="tab-content setting-tab">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <select class="form-control" name="open_time">
                                ...
                                @for($i = 1; $i <= 24; $i++)
                                    <option {!! $setting['open_time'] == $i ? 'selected' : '' !!} value="{!! $i !!}">{!! $i !!}</option>
                                @endfor
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <select class="form-control" name="close_time">
                                ...
                                @for($i = 1; $i <= 24; $i++)
                                    <option {!! $setting['close_time'] == $i ? 'selected' : '' !!} value="{!! $i !!}">{!! $i !!}</option>
                                @endfor
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <select class="form-control">
                                ...
                                @for($i = 24; $i <= 24; $i++)
                                    <option {!! $setting['delievery_margin'] == $i ? 'selected' : '' !!} value="{!! $i !!}">{!! $i !!}</option>
                                @endfor
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-10">
                            <select class="form-control" name="is_shop_close">
                                ...
                                @foreach([0 => 'no', 1 => 'yes'] as $key => $val)
                                    <option {!! $setting['is_shop_close'] == $key ? 'selected' : '' !!} value="{!! $key !!}">{!! $val !!}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div role="tabpanel" class="tab-pane" id="tab7">
                    <?php
                    $delivery_charges = json_decode($setting->delivery_charges,true);
                    //dd($delivery_charges);
                    foreach($locations as $l):?>

                    <div class="form-group">
                        <label for="delivery_charges_<?php echo $l->currency_code; ?>" class="col-lg-2 control-label">Delivery Charges for <?php echo $l->name;?></label>
                        <div class="col-lg-10">
                            <input placeholder="Delivery Charges for <?php echo $l->name;?>" rows="2" name="delivery_charges[<?php echo $l->currency_code; ?>]" type="text" id="delivery_charges_<?php echo $l->currency_code; ?>" class="form-control" value="<?php if(isset($delivery_charges[$l->currency_code]))echo $delivery_charges[$l->currency_code];?>">
                        </div>
                    </div>
                    <?php endforeach?>
                    <!--form control-->
                ...
                <div role="tabpanel" class="tab-pane" id="tab8">
                    <?php
                    $sorting_fee = json_decode($setting->sorting_fee,true);
                    //dd($delivery_charges);
                    foreach($locations as $l):?>

                    <div class="form-group">
                        <label for="delivery_charges_<?php echo $l->currency_code; ?>" class="col-lg-2 control-label">Sorting Fee for <?php echo $l->name;?></label>
                        <div class="col-lg-10">
                            <input placeholder="Sorting Fee for <?php echo $l->name;?>" rows="2" name="sorting_fee[<?php echo $l->currency_code; ?>]" type="text" id="sorting_fee_<?php echo $l->currency_code; ?>" class="form-control" value="<?php if(isset($sorting_fee[$l->currency_code]))echo $sorting_fee[$l->currency_code];?>">
                        </div>
                    </div>
                    <?php endforeach?>
                    <!--form control-->
