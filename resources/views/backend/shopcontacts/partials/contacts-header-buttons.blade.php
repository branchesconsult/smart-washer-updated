<!--Action Button-->
@if( Active::checkUriPattern( 'admin/shopcontacts' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.shopcontacts.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.contacts.all' ) }}
            </a>
        </li>
        @permission( 'create-contact' )
            <li>
                <a href="{{ route( 'admin.shopcontacts.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.contacts.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
