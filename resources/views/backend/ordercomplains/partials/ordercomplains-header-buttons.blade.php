<!--Action Button-->
@if( Active::checkUriPattern( 'admin/ordercomplains' ) )
    <div class="btn-group">
...
<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.ordercomplains.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.ordercomplains.all' ) }}
            </a>
        </li>
        @permission( 'create-ordercomplain' )
            <li>
                <a href="{{ route( 'admin.ordercomplains.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.ordercomplains.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
