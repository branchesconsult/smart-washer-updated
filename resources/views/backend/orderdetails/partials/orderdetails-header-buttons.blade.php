<!--Action Button-->
@if( Active::checkUriPattern( 'admin/orderdetails' ) )
    <div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <li>
            <a href="{{ route( 'admin.orderdetails.index' ) }}">
                <i class="fa fa-list-ul"></i> {{ trans( 'menus.backend.orderdetails.all' ) }}
            </a>
        </li>
        @permission( 'create-orderdetail' )
            <li>
                <a href="{{ route( 'admin.orderdetails.create' ) }}">
                    <i class="fa fa-plus"></i> {{ trans( 'menus.backend.orderdetails.create' ) }}
                </a>
            </li>
        @endauth
    </ul>
